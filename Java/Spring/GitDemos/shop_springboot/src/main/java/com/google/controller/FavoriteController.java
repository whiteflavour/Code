...
public class FavoriteController {
    ...
    @GetMapping("/favorite")
    public String favoritePage(@RequestParam("name")String name, @RequestParam("price")double price, @RequestParam("username")String username, Model model) {
        Consumer consumer = iOnlineService.findOnlineUser(username);
        if (consumer == null) {
