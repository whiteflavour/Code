...
public class TicketServlet extends HttpServlet
{
    ...
    private void showTicketForm(HttpServletRequest request,
            ...
            throws ServletException, IOException
    {
        request.getRequestDispatcher("/WEB-INF/view/ticketForm.jsp")
            ...
            throws ServletException, IOException
    {
        ...
        request.getRequestDispatcher("/WEB-INF/view/viewTicket.jsp")
                .forward(request, response);
    }
            ...
            throws ServletException, IOException
    {
        ...
        request.getRequestDispatcher("/WEB-INF/view/listTickets.jsp")
                .forward(request, response);
    }
